...
try:
    ...
    def funk(f):
        ...
        driver.get('https://valkompass.tt.se/v1/index.html?customerId=Arbetet-LO-Mediehus')
        ...
        def fraga(i):
            ...
            driver.find_element(By.XPATH, '//*[@id="root"]/div/div[1]/div/div/div[' + str(
                i) + ']/div/section/div/div/section[1]/div/div/div[2]/div[' + str(randalt) + ']').click()
        ...
        insert = "INSERT INTO arbetet (V, S, MP, C, L, M, KD, SD) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
